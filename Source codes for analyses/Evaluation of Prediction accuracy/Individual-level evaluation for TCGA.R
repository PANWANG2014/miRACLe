...
z10_con = promise_sam(z3[[1]], z3[[2]], z6_con[[3]], thres_num, z5) #result of promise
...
write.table(z10_con[[1]],file="Validation rate for promise mrna.txt",quote=FALSE,sep="\t")
write.table(z10_con[[2]],file="Validation rate for promise joint.txt",quote=FALSE,sep="\t")
