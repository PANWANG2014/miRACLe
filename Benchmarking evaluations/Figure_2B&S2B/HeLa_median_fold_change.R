...
medfc_summary = function(vset){
  ...
  z32 = medfc_vector(z31[[1]], z31[[2]]) #for promise all_mrna competition model
  z33 = medfc_test(vset, promise_all_result[[1]], z13[[1]], z13[[3]], num)
  z34 = medfc_vector(z33[[1]], z33[[2]]) #for promise all_full competition model
  z35 = medfc_test(vset, promise_conserved_result[[1]], z14[[1]], z14[[3]], num)
  z36 = medfc_vector(z35[[1]], z35[[2]]) #for promise conserved_mrna competition model
  z37 = medfc_test(vset, promise_conserved_result[[1]], z15[[1]], z15[[3]], num)
  z38 = medfc_vector(z37[[1]], z37[[2]]) #for promise conserved_full competition model
  ...
  final_median = rbind(z28[1:500], z30[1:500], z32[1:500], z34[1:500], z36[1:500], z38[1:500], z40[1:500], z42[1:500],  
                       z44[1:500], z46[1:500], z48[1:500], z50[1:500], z52[1:500], z54[1:500])
...
write.table(final_Selbach, file = "Microarray_MFC_Selbach.txt", quote = FALSE, sep = "\t")
write.table(final_Liu, file = "Microarray_MFC_Liu.txt", quote = FALSE, sep = "\t")
...
write.table(final_Grimson, file = "Seq_MFC_Selbach.txt", quote = FALSE, sep = "\t")
write.table(final_Liu, file = "Seq_MFC_Liu.txt", quote = FALSE, sep = "\t")